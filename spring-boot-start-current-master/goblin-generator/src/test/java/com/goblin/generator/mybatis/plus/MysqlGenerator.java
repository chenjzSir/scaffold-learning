...
public class MysqlGenerator {
	...
	public static void main ( String[] args ) {
		...
		AutoGenerator mpg = new AutoGenerator().setGlobalConfig(
			// 全局配置
			new GlobalConfig()
				.setOutputDir( projectPath+"/spring-boot-start-current-master/goblin-generator/src/main/java" )//输出目录
			...
			new DataSourceConfig()
					...
					.setUsername( "root" )
					.setPassword( "123456" )
					.setUrl( "jdbc:mysql://127.0.0.1:3306/goblin?useUnicode=true&useSSL=false&characterEncoding=utf8" )
		).setStrategy(
			// 策略配置
			new StrategyConfig()
			...
			new PackageConfig()
				// .setModuleName( "test" )
				.setParent( "com.goblin.manage" )// 自定义包路径
